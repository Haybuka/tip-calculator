  ...
  return (
    <aside className="People">
      <h3 className='People-h3'>
        <p className='text-dark'>Number of People</p>
        <p className="text-red-500">{people < 1 && "Can't be zero"}</p>
      </h3>
      <form className='relative '>
         <svg xmlns="http://www.w3.org/2000/svg" width="13" height="16" className='People-svg'>
          ...
          <input value={people} onChange={e=> setPeople(e.target.value)} type='text' placeholder="0" className={people < 1 ? 'border border-red-500 People-input' : 'People-input'} />
      </form>
    </aside>
  )
}
